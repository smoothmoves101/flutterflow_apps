...
class Day26Widget extends StatefulWidget {
  const Day26Widget({super.key});

  @override
  State<Day26Widget> createState() => _Day26WidgetState();
}

class _Day26WidgetState extends State<Day26Widget> {
  late Day26Model _model;
