...
import 'day1_model.dart';
export 'day1_model.dart';

class Day1Widget extends StatefulWidget {
  const Day1Widget({super.key});

  @override
  State<Day1Widget> createState() => _Day1WidgetState();
}

class _Day1WidgetState extends State<Day1Widget> {
  late Day1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day1Model());
